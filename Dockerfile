...
RUN mkdir -p /opt/jboss/keycloak/modules/system/layers/base/com/microsoft/sqlserver/jdbc/main && \
  cd /opt/jboss/keycloak/modules/system/layers/base/com/microsoft/sqlserver/jdbc/main && \
